	    ...
	    <div>
	      <ul class="nav navbar-nav">
	        ...
	        <li class="dropdown">
			  ...
			  <li class="active"><a href="daftar-peminjaman-alat.php">Daftar Peminjaman</a></li>  
...
<?php
	...
	$sql = "SELECT * FROM alat a, peminjam p, details_peminjaman_alat x WHERE a.kode = x.id_alat AND p.id_peminjam = x.id_peminjam";
	...
	if($count>0){
		...
		while($row = mysqli_fetch_assoc($result)) {
			...
			$row["id_peminjaman_alat"]."</td><td>".
			$row["id_pegawai"]."</td><td>".
